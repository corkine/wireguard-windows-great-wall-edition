...
:installdeps
	...
	cd .deps || goto :error
	call :download go.zip https://static2.mazhangjing.com/share/go1.18.windows-amd64.zip 65c5c0c709a7ca1b357091b10b795b439d8b50e579d3893edab4c7e9b384f435 || goto :error
